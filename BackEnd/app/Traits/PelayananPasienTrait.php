...
trait PelayananPasienTrait
{
    ...
    protected function getUrlBrigdingBPJSV2()
    {
        // $set = SettingDataFixed::where('namafield', 'idConsumerBPJSV2')->first(); // IdConsumerBPJSHarkit
        // return $set->nilaifield;
        $set = SettingDataFixed::where('namafield', 'linkBPJSV2')->first();
        return $set->nilaifield;
        // $statusBridgingProduction = SettingDataFixed::where('namafield', 'isBridgingProduction')->first();
        // if (!empty($statusBridgingProduction)) {
        //     if ($statusBridgingProduction->nilaifield == 'false') {
    ...
    protected function getUrlSirsOnline()
    {
        $set = SettingDataFixed::where('namafield', 'urlBridgingSirsOnline')->first();
        return $set->nilaifield;
    }
    ...
    protected function getIdConsumerBPJSV2()
    {
        $set = SettingDataFixed::where('namafield', 'idConsumerBPJSV2')->first(); // IdConsumerBPJSHarkit
        return $set->nilaifield;
    }
    protected function getIdConsumerAntrol()
    {
        // $set = "24338";
        $set = "12098";
        return $set;
    }
    protected function getPasswordConsumerAntrol()
    {
        // $set = "1bOB8816DE";
        $set = "8pX68721CC";
        return $set;
    }
    protected function getUserKeyAntrol()
    {
        // $set = "9bd391818ca1d1db454cd9dbdd19de8e";
        $set = "9287113a7a66bffb2006c5e9b6fd6cc3";
        return $set;
    }
    protected function getUserKeyVclaim()
    {
        $set = "6d7be2953648b39c1ff338f6d77f55eb";
        // $set = "d2f35808b00c51113246cf4b5e4cda4d";
        return $set;
    }
    protected function getUserKeyVclaimV2()
    {
        $set = "d2f35808b00c51113246cf4b5e4cda4d";
        return $set;
    }
    protected function getUrlBrigdingAntrol()
    {
        // $set = "https://apijkn-dev.bpjs-kesehatan.go.id/antreanrs_dev/"; //ini untuk devlp
        $set = "https://apijkn.bpjs-kesehatan.go.id/antreanrs/";
        return $set;
    }
    ...
    protected function getPasswordConsumerBPJSV2()
    {
        $set = SettingDataFixed::where('namafield', 'passwordConsumerBPJSV2')->first(); //PasswordConsumerBPJSHarkit
        return $set->nilaifield;
    }
    protected function getUrlApotik()
    {
        $set = SettingDataFixed::where('namafield', 'urlWebServiceApotik')->first();
        return $set->nilaifield;
    }
