...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            ...
            //     label: 'Master',
            //     items:[
            //         {    label: 'Obat', icon: 'pi pi-fw pi-check-square', routerLink: ['/pages/daftarmaster'],}
            //     ]
            // },
            // {
            //     label: 'UI Components',
            ...
            // },
            {
                ...
                items: [
                    {
                        label: 'Input Resep', icon: 'pi pi-fw pi-check-square', routerLink: ['/pages/resep'],
                    ...
                    {
                         label: 'Daftar Resep', icon: 'pi pi-fw pi-check-square', routerLink: ['/pages/daftarresep'],
                    }
                    // {
